...
public:
	/** @brief Constructor.
	  * @details Menciptakan sebuah array dinamik baru dengan ukuran awal (jumlah elemen) nol.
	...
	/** @brief Copy Constructor.
	  ...
	  * dengan data dicopy (bukan bitwise copy) dari array dinamik lain.
	...
	/** @brief Operator=.
	  * @details Menjamin data dicopy (bukan bitwise copy) dari array dinamik lain.
	  * @param array array dinamik yang dicopy.
	...
	/** @brief Memeriksa apakah array dinamik kosong atau tidak.
	  * @details array dinamik yang kosong adalah array dinamik dengan ukuran (jumlah elemen) = 0.
	...
	/** @brief Mencari elemen dengan nilai tertentu pada array dinamik.
	  ...
	  * @return Hasil pencarian berupa indeks terkecil tempat nilai elmt pertama kali ditemukan.
