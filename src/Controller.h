...
/** @class Controller.
  * Kelas Controller yang berfungsi untuk menjalankan fitur-fitur pada virtual zoo.
  */
class Controller {
public:
  /** @brief Constructor.
    ...
    * @param use_color Mengatur apakah Controller ini akan mencetak output secara
    * berwarna.
    */
